...
export const Heading = React.forwardRef<React.ElementRef<typeof DEFAULT_TAG>, HeadingProps>((props, forwardedRef) => {
  ...
  const textCss: Record<HeadingSizeVariants, CSS> = {
    ...
    2: { fontWeight: 600, lineHeight: '25px', '@bp2': { lineHeight: '30px' } },
    3: { fontWeight: 800, lineHeight: '33px', '@bp2': { lineHeight: '41px' } },
    4: { fontWeight: 800, lineHeight: '35px', '@bp2': { lineHeight: '60px' } },
  };
